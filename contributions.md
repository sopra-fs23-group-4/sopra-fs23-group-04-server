...
| Christopher Narayanan | (#103), (#108),#275           | #119, #120,#103, #108     | struggelingwebsockets tried to copy the approach of Ravewave group from last year however not working, adding functionality to get standard categories                                              |
...
| Christopher Narayanan | (#119) , (#120),#103      |  #120, #119           | struggeling with websocket, thinking of a different approach even though the setup in the backend worked connecting the frontend didn't https://umes4ever.medium.com/real-time-application-using-websocket-spring-boot-java-react-js-flutter-eb87fe95f94f                                                                   |
...
| Christopher Narayanan |# 120, #145, (#108), #119              | #123, #201, #108                 |websocket working on a page using a different approach , testing repositories ... the future Chris : Problem was the DTO being sent was missing a get function and not knowing that one can debug the frotnend was kind of problem, this would have solved this issue earlier                                          |
...
| Christopher Narayanan | #123  #201, #66, #120, #119, #277, #108         |  #208, #197, #223, #276          | implementing fact api, websocket working locally, fixing type issue with websockets timer implementedn              |
...
|-----------------------|------------------------------------|----------------------------------------------------------------------------------------------------------|
| Alexandre Bacmann     | #183,#184,#185,#186,#188,#192,#199,#279          |  unit test servic classes, Gamecontroller, votecontroller, Readme, fix issue: leaving game                                                                                                                                                                                    |
...
| Lennart Töllke        | #68, #63, #57, #58, #59, #76, #79, #82, #84,#282             | added pop up to leave button and progress bar on score page, InGameRouter, routing to User Page, fixed Bugs and code smells, made leaderboard fancy and button work, refactored websocket into single instance, handled more info from websocket dtos                    |
