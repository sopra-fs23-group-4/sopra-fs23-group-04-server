...
public class GameController {
    ...
    @GetMapping("/games/lobbies/{gamePin}/rejoin")
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public RejoinRequestDTO rejoinAttempt(@RequestHeader("Authorization") String userToken, @PathVariable("gamePin") int gamePin){
        return gameService.rejoinRequestDTO(userToken,gamePin);
